...
*D.3 is done (see Completed). Forward path:*
...
- **D.4 Bridge auto-restart**: a watchdog that restarts the bridge if /health fails (the backlog persistence of D.3 makes restarts safe — no order loss).
